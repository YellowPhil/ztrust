...
pub static ZONE: Lazy<Realm> =
    Lazy::new(|| Realm::new("zone".to_owned()).expect("static realm is less than 128 chars"));
...
impl AuthenticatedMessage {
    ...
    pub(crate) fn new(
        ...
        let message_integrity =
            MessageIntegrity::new_long_term_credential(&message, &username, &ZONE, &password)?;
